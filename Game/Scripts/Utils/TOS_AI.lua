...
GN_MARK_DEFEND_POS = 1 -- Пометить позицию обороны.
GN_CLEAR_DEFEND_POS = 2 -- Очистить позицию обороны.
GN_AVOID_CURRENT_POS = 3 -- Избегать текущей позиции.
...
AI_CHECK_SLOPE_DISTANCE = 262144 -- Проверять расстояние до склона
