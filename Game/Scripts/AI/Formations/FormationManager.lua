...
--	AI.AddFormationPointFixed("line_follow2",170,-0.5,2,0,SPECIAL_FORMATION_POINT);
	...
	AI.CreateFormation("alien_escort3");
	AI.AddFormationPointFixed("alien_escort3",90,15,15,15,UNDEFINED);
	AI.AddFormationPointFixed("alien_escort3",-90,15,-15,15,UNDEFINED);	
	AI.AddFormationPointFixed("alien_escort3",180,-15,15,-15,UNDEFINED);	
	AI.AddFormationPointFixed("alien_escort3",180,-15,-15,-15,UNDEFINED);
	
	AI.CreateFormation("alien_escort4");
	AI.AddFormationPoint("alien_escort4",90,15,15,UNDEFINED,15,15,15);
	AI.AddFormationPoint("alien_escort4",-90,15,-15,UNDEFINED,15,-15,15);	
	AI.AddFormationPoint("alien_escort4",180,30,15,UNDEFINED,30,15,-15);	
	AI.AddFormationPoint("alien_escort4",180,30,-15,UNDEFINED,30,-15,-15);
	
	AI.CreateFormation("vtol_escort");
	AI.AddFormationPointFixed("vtol_escort",90,30,30,15,UNDEFINED);
	AI.AddFormationPointFixed("vtol_escort",-90,30,-30,15,UNDEFINED);	
	AI.AddFormationPointFixed("vtol_escort",180,-30,30,-15,UNDEFINED);	
	AI.AddFormationPointFixed("vtol_escort",180,-30,-30,-15,UNDEFINED);
	
	AI.CreateFormation("alien_guardian_idle1");
	AI.AddFormationPointFixed("alien_guardian_idle1",0,0,-10,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_idle1",60,6,4,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_idle1",-90,-4, 7,0,UNDEFINED);	
	
	AI.CreateFormation("alien_guardian_idle2");
	AI.AddFormationPointFixed("alien_guardian_idle2",120,3,-6,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_idle2",-150,-8,-2,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_idle2",45,0, 5,0,UNDEFINED);	

	AI.CreateFormation("alien_guardian_alert1");
	AI.AddFormationPointFixed("alien_guardian_alert1",180,0,-8,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_alert1",60,7,4,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_alert1",-60,-7, 4,0,UNDEFINED);	
	
	AI.CreateFormation("alien_guardian_alert2");
	AI.AddFormationPointFixed("alien_guardian_alert2",120,7,-4,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_alert2",-120,-7,-4,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_alert2",0,0, 8,0,UNDEFINED);	

	AI.CreateFormation("alien_guardian_combat1");
	AI.AddFormationPointFixed("alien_guardian_combat1",180,0,-6,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_combat1",60,5,3,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_combat1",-60,-5, 3,0,UNDEFINED);	
	
	AI.CreateFormation("alien_guardian_combat2");
	AI.AddFormationPointFixed("alien_guardian_combat2",120,5,-3,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_combat2",-120,-5,-3,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_combat2",0,0, 6,0,UNDEFINED);
	
	AI.CreateFormation("alien_guardian_combat3");
	AI.AddFormationPointFixed("alien_guardian_combat1",-60,-5, 3,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_combat1",60,5,3,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_combat1",180,0,-6,0,UNDEFINED);

	AI.CreateFormation("alien_guardian_protect1");
	AI.AddFormationPointFixed("alien_guardian_protect1",0,2,2,0,UNDEFINED);
	AI.AddFormationPointFixed("alien_guardian_protect1",0,-2,2,0,UNDEFINED);	
	AI.AddFormationPointFixed("alien_guardian_protect1",0,3,-3,0,UNDEFINED);	
