function PipeManager:OnInit2()
	...
	AI.CreateGoalPipe("test_strafe");
	AI.PushGoal("test_strafe", "bodypos", 1, BODYPOS_STAND, 1);
	-- Be able to shoot while going anywhere
	-- 100 (meters) result in "strafe all the way"
	--
	AI.PushGoal("test_strafe", "strafe", 0, 100, 100);
	--
	AI.PushGoal("test_strafe", "firecmd", 0, FIREMODE_FORCED);
	AI.PushGoal("test_strafe", "locate", 0, "probtarget");
	AI.PushGoal("test_strafe", "+seekcover",1, COVER_HIDE, 20, 2, 1);
	AI.PushGoal("test_strafe", "signal", 1, 1, "COVER_NORMALATTACK", 0);
	...
	AI.PushGoal("start_fire","firecmd",1,FIREMODE_KILL);
