...
function PipeManager:OnInit()
	...
	Script.ReloadScript("Scripts/AI/GoalPipes/PipeManagerTheOtherSide.lua");
	...
	Script.ReloadScript("Scripts/AI/GoalPipes/PipeManagerTrooperMKII.lua");
	...
	PipeManager:OnInitTheOtherSide();
