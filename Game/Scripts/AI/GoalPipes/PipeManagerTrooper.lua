...
--	AI.EndGoalPipe();
	...
	AI.BeginGoalPipe("tr_minion_shoot");
		AI.PushGoal("locate",0,"formation",1000);
		AI.PushGoal("+acqtarget",0,"");
		AI.PushGoal("+locate",0,"formationsight",1000);
		AI.PushGoal("+stick",0,1.0,AILASTOPRES_LOOKAT+AI_REQUEST_PARTIAL_PATH,0);
		--AI.PushGoal("timeout",1,3);
		--AI.PushGoal("firecmd",0,FIREMODE_BURST);
		AI.PushGoal("firecmd",1,FIREMODE_CONTINUOUS);
		...
		AI.PushGoal("firecmd",1,0);
		AI.PushGoal("timeout",1,1);
		AI.PushGoal("signal",1,1,"END_MINION_SHOOT",SIGNALFILTER_SENDER);
	AI.EndGoalPipe();
	
	AI.BeginGoalPipe("tr_minion_shoot_cover");
		AI.PushGoal("locate", 0, "refpoint");
		AI.PushGoal("+firecmd",0,FIREMODE_FORCED,AILASTOPRES_USE);
		AI.PushGoal("+timeout",1,2);
		AI.PushGoal("firecmd",0,0);
	AI.EndGoalPipe();

	AI.BeginGoalPipe("tr_stay_on_wall");
		AI.PushGoal("timeout",1,0.3);
		AI.PushGoal("signal",1,1,"ON_WALL",SIGNALFILTER_SENDER);
		AI.PushGoal("firecmd",1,FIREMODE_CONTINUOUS);
		AI.PushGoal("timeout",1,2.9,3.9);
	...
	AI.BeginGoalPipe("tr_stay_on_rock");
		AI.PushGoal("timeout",1,0.3);
		AI.PushGoal("signal",1,1,"ON_ROCK",SIGNALFILTER_SENDER);
		AI.PushGoal("firecmd",1,FIREMODE_CONTINUOUS);
		AI.PushGoal("timeout",1,2.9,3.9);
		AI.PushGoal("firecmd",1,0);
		AI.PushGoal("signal",0,1,"END_SHOOT_ON_WALL",SIGNALFILTER_SENDER);
	...
	AI.BeginGoalPipe("tr_turret_shoot_cover");
		AI.PushGoal("timeout",1,0.3);
		AI.PushGoal("signal",1,1,"ON_WALL",SIGNALFILTER_SENDER);
		AI.PushGoal("locate", 0, "refpoint");
		AI.PushGoal("+firecmd",1,FIREMODE_FORCED, AILASTOPRES_USE);
		AI.PushGoal("+timeout",1,2.9,3.9);
		AI.PushGoal("firecmd",1,0);
		AI.PushGoal("signal",0,1,"END_SHOOT_ON_WALL",SIGNALFILTER_SENDER);
		AI.PushGoal("timeout",1,1.0,1.3);
...
--	AI.EndGoalPipe();
	...
	AI.BeginGoalPipe("tr_siege");
		AI.PushGoal("run",1,1);
		AI.PushGoal("firecmd",0,FIREMODE_BURST);
		AI.PushGoal("timeout",1,2);
		--AI.PushGoal("firecmd",0,0);
		AI.PushGoal("signal",1,1,"TR_NORMALATTACK",0);
	AI.EndGoalPipe();
