...
AIBehaviour.ScoutMOACDefault = {
	...
	ACT_SHOOTAT = function( self, entity, sender, data )
		...
		--System.LogAlways("SCOUTDEFAULT_ACT_SHOOTAT "..entity:GetName());
	...
	scoutCheckHostile = function ( self, entity, target )
		...
		--TheOtherSide
		local hostile1 = target.Properties.species ~= entity.Properties.species
		local hostile2 = AI.Hostile( entity.id, target.id );
		--~TheOtherSide

		if (hostile1 or hostile2) then
			return true;
		end
