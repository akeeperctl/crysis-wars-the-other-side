...
--   created: Integrated to Trooper AI by Denisz Polg�r 31.01.2008.


AIBehaviour.Trooper2Seek = {
	Name = "Trooper2Seek",
	Base = "Trooper2Attack",
	alertness = 1,
	...
	COVER_NORMALATTACK = function (self, entity)
		...
		--				entity:SelectPipe(0,"cv_seek_defend");
					...
					elseif(AI_Utils:IsTargetOutsideTerritory(entity) == 0 and AI.GetGroupTacticState(entity.id, 0, GE_NEAREST_SEEK) == 1) then
						...
						entity:SelectPipe(0,"tr2_seek_direct");
					else
...
--		entity:SelectPipe(0,"tr2_use_cover_safe");
...
----				entity:Readibility("taunt",1,2,0.1,0.4);
----				entity:SelectPipe(0,"tr2_fast_advance_to_target");
----			else
--				entity:Readibility("taunt",1,2,0.1,0.4);
--				entity:SelectPipe(0,"tr2_investigate_probable_target"); 
----			end
--		
----			entity:SelectPipe(0,"tr2_refpoint_investigate"); 
--			
