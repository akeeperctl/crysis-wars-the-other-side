...
AIBehaviour.Trooper2AvoidExplosives = {
	Name = "Trooper2AvoidExplosives",
	Base = "TROOPERDEFAULT",
	alertness = 2,
	exclusive = 1,
	...
	--		entity:Readibility("explosion_imminent",1,1,0.1,0.4);
			...
			if (entity.AI.grenadeDist) then
				if (entity.AI.grenadeDist > 6.0) then
					entity:SelectPipe(0,"tr2_backoff_from_explosion_short");
				else
					entity:SelectPipe(0,"tr2_backoff_from_explosion");
				end
			else
				entity:SelectPipe(0,"tr2_backoff_from_explosion");
			end
