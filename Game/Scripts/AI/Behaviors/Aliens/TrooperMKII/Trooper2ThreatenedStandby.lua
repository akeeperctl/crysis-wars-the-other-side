--------------------------------------------------
-- Trooper2ThreatenedStandby
-- Trheatened behavrio when approaching the target is not permitted.
--------------------------
--   created: Mikko Mononen 13-9-2006
--   created: Integrated to Trooper AI by Denisz Polgбr 31.01.2008.

AIBehaviour.Trooper2ThreatenedStandby = {
	Name = "Trooper2ThreatenedStandby",
	Base = "TROOPERDEFAULT",
	alertness = 1,
...
--		end
		...
		if (AI_Utils:IsTargetOutsideStandbyRange(entity) == 0) then
			...
			entity:SelectPipe(0,"tr2_look_closer_standby");
		end
