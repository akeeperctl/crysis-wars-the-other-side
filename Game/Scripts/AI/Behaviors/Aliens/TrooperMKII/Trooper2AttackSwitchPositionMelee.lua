...
AIBehaviour.Trooper2AttackSwitchPositionMelee = {
	Name = "Trooper2AttackSwitchPositionMelee",
	Base = "Trooper2AttackSwitchPosition",
	alertness = 2,
...
--		end
	...
	STAY_AWAY_FROM 	 = function (self,entity,sender,data)
		if(entity.AI.canDodge) then 
			AIBehaviour.Trooper2AttackSwitchPosition:STAY_AWAY_FROM(entity,sender,data);
		end
	end,
