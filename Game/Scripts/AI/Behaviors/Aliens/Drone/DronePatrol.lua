...
AIBehaviour.DronePatrol = {
	...
	Constructor = function ( self, entity, data )
		...
		Script.SetTimerForFunction( minUpdateTime *1000, "AIBehaviour.DronePatrol.SCOUTMOACPATROL_UPDATE", entity );
	...
	SCOUTMOACPATROL_UPDATE = function( entity )
		...
		if ( target and AIBehaviour.ScoutMOACDefault:scoutCheckHostile( entity, target )==true ) then
			AIBehaviour.DronePatrol:OnPlayerSeen( entity, 0 );
		end
		...
		if ( entity.AI.CurrentHook == fSCOUTMOACPATROL_DONOTHING ) then
			AIBehaviour.DronePatrol:SCOUTMOACPATROL_DONOTHING( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACPATROL_PATROL1 ) then
			AIBehaviour.DronePatrol:SCOUTMOACPATROL_PATROL1( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACPATROL_PATROL2 ) then
			AIBehaviour.DronePatrol:SCOUTMOACPATROL_PATROL2( entity );
		elseif ( entity.AI.CurrentHook == fSCOUTMOACPATROL_PATROL3 ) then
			AIBehaviour.DronePatrol:SCOUTMOACPATROL_PATROL3( entity );
		else
			AIBehaviour.DronePatrol:SCOUTMOACPATROL_DONOTHING( entity );
		end		
