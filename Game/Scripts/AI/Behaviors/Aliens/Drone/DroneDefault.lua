...
AIBehaviour.DroneDefault = {
	...
	SCOUTMOAC_ANTICIPATION_RESPONSE = function( self, entity, sender, data )
		...
		Script.SetTimerForFunction( wtime , "AIBehaviour.DroneDefault.SCOUTMOAC_ANTICIPATION_RESPONSE2", entity );
	end,
	...
	ACT_SHOOTAT = function( self, entity, sender, data )
		...
		if ( data.fValue > 0.0 ) then
		  ...
		  Script.SetTimerForFunction( data.fValue *1000, "AIBehaviour.DroneDefault.ACT_SHOOTAT_END", entity );
		end
