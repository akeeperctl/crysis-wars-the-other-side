...
--		entity:SelectPipe(0,"cover_beacon_pindown");
	...
	OnBodyFallSound = function(self, entity, sender, data)
		--Р’С‹Р·С‹РІР°РµС‚СЃСЏ РєРѕРіРґР° РєС‚Рѕ-С‚Рѕ РёР· РіСЂСѓРїРїС‹ СѓРјРµСЂ РІ СЂР°РґРёСѓСЃРµ 10 РјРµС‚СЂРѕРІ
	...
	OnSomebodyDied = function( self, entity, sender)
		--Р’С‹Р·С‹РІР°РµС‚СЃСЏ РєРѕРіРґР° РєС‚Рѕ-С‚Рѕ РёР· РЅРµ РіСЂСѓРїРїС‹ СѓРјРµСЂ РІ СЂР°РґРёСѓСЃРµ РїР°СЂР°РјРµС‚СЂР° sightrange
