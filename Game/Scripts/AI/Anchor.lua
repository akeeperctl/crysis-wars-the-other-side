...
--	ACTION_RECOG_CORPSE = 354,
	...
	--TOS_SA - The Other Side Strategic Area

	-- user by ai soldiers in conquest gamemode
	TOS_SA_CENTRE_SPOT = 250, 

	-- used by air vehicles when load paratroopers
	--not used now
	TOS_SA_AIRVEHICLE_LANDING_SPOT = 251, 

	-- used by cars, plv. setup radius 6m minimum!
	TOS_SA_LANDVEHICLE_UNLOAD_SPOT = 252, 
	
	--used by air vehicles when unload paratroopers, setup radius 6m minimum!
	TOS_SA_AIRVEHICLE_UNLOAD_SPOT = 253, 
