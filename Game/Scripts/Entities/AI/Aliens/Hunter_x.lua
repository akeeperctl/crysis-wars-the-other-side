...
------------------------------------------------------
function Hunter_x:AbilityHunterThrow(grabId, throwPos, scheme)
...
function Hunter_x:RegAI(bPlayer)
	if bPlayer then
...
-- function Hunter_x:UpdateEnergy(frameTime)
...
function Hunter_x:DoPlayerSeen()
  	...
  	--System.Log ("Hunter_x:DoPlayerSeen() called");	
...
function Hunter_x:DoShootWeapon()
  ...
  System.LogAlways("Hunter_x:DoShootWeapon() called");	
