...
function BasicAI:RegisterAI()
	...
	if (self ~= g_localActor) then
		...
		AI.ChangeParameter(self.id,AIPARAM_COMBATCLASS,AICombatClasses.Infantry);
		AI.ChangeParameter(self.id,AIPARAM_FORGETTIME_TARGET,self.Properties.Perception.forgetTimeTarget);
		AI.ChangeParameter(self.id,AIPARAM_FORGETTIME_SEEK,self.Properties.Perception.forgetTimeSeek);
		AI.ChangeParameter(self.id,AIPARAM_FORGETTIME_MEMORY,self.Properties.Perception.forgetTimeMemory);
