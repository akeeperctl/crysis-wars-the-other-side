...
function Grunt_x:Event_EnableRagdoll(params)
	self.actor:SetPhysicalizationProfile("sleep");
end

function Grunt_x:Event_DisableRagdoll(params)
...
Grunt_x.FlowEvents =
{
	Inputs =
	{
		EnableRagdoll = { Grunt_x.Event_EnableRagdoll, "bool" },
		DisableRagdoll = { Grunt_x.Event_DisableRagdoll, "bool" },
	},
	Outputs =
	{
	},
