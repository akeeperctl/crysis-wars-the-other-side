...
void SCVars::InitCVars(IConsole* pConsole)
{
	...
	//TheOtherSide
	pConsole->Register("tos_debug_log_all", &tos_debug_log_all, 0, VF_CHEAT, "");
	pConsole->Register("tos_show_version", &tos_show_version, 0, VF_CHEAT, "1 - Show The Other Side Build Number");
	pConsole->Register("tos_debug_draw_aiactiontracker", &tos_debug_draw_aiactiontracker, 0, VF_CHEAT, "");
	pConsole->Register("tos_debug_log_aiactiontracker", &tos_debug_log_aiactiontracker, 0, VF_CHEAT, "");

	pConsole->Register("g_trooperMeleeDamage", &g_trooperMeleeDamage, 80, VF_CHEAT, "");
	pConsole->Register("g_trooperMeleeDamageMultiplier", &g_trooperMeleeDamageMultiplier, 1.2f, VF_CHEAT, "");
	pConsole->Register("g_trooperVehicleDamageMultiplier", &g_trooperVehicleDamageMultiplier, 0.35f, VF_CHEAT, "");
	
	pConsole->Register("sqd_ScoutCanSearch", &sqd_ScoutCanSearch, 0, VF_SAVEGAME || VF_RESTRICTEDMODE, "Can the controlled alien scout sent search signal to allies when see the enemy with light mode?");
	pConsole->Register("sqd_HideControls", &sqd_HideControls, 0, VF_SAVEGAME || VF_RESTRICTEDMODE, "Hide/Show Squad hud controls");
	pConsole->Register("sqd_TrooperCanSay", &sqd_TrooperCanSay, 0, VF_SAVEGAME || VF_RESTRICTEDMODE, "Can the controlled alien trooper sent voice signal when shoot at enemy?");
	pConsole->Register("sqd_vehicle_follow_method", &sqd_vehicle_follow_method, 0, VF_CHEAT, "0 - vehicle following the leader, 1 - member out from vehicle and follow the leader");
	pConsole->Register("sqd_debug_log_detached", &sqd_debug_log_detached, 0, VF_CHEAT, "Log squad detached members info");
	pConsole->Register("sqd_debug_log_creating", &sqd_debug_log_creating, 0, VF_CHEAT, "Log squad creating info");
	pConsole->Register("sqd_debug_log_executing", &sqd_debug_log_executing, 0, VF_CHEAT, "Log squad order executing info");
	pConsole->Register("sqd_debug_log_hidespots", &sqd_debug_log_hidespots, 0, VF_CHEAT, "Log info about booking hidespots");
	pConsole->Register("sqd_debug_draw_Info", &sqd_debug_draw_Info, 0, VF_CHEAT, "Show information about squads on the display.");
	pConsole->Register("sqd_debug_draw_client_squad", &sqd_debug_draw_client_squad, 0, VF_CHEAT, "Show information about player squad on the display.");
	pConsole->Register("sqd_membersUpdateDelay", &sqd_membersUpdateDelay, 0.5f, VF_CHEAT, "");
	pConsole->Register("sqd_detachedUpdateDelay", &sqd_detachedUpdateDelay, 0.5f, VF_CHEAT, "");
	//pConsole->Register("sqd_debug_log", &sqd_debug_log, 0, VF_CHEAT, "Write Squad System logs in the console.");

	g_singleplayer_start_map = pConsole->RegisterString("g_singleplayer_start_map", "island", VF_RESTRICTEDMODE);
	
	pConsole->Register("abil_debug_draw_info", &abil_debug_draw_info, 0, VF_CHEAT, "Show information about your abilities on the display.");
	pConsole->Register("abil_debug_log", &abil_debug_log, 0, VF_CHEAT, "Write Abilities System logs in the console.");

	pConsole->Register("conq_debug_draw_rar_requests", &conq_debug_draw_rar_requests, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_draw_commanders", &conq_debug_draw_commanders, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_draw_commander_squads", &conq_debug_draw_commander_squads, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_draw_aichannel", &conq_debug_draw_aichannel, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_draw_client_area", &conq_debug_draw_client_area, 0, VF_CHEAT, "Show information about player area on the display.");
	pConsole->Register("conq_debug_log_vehiclespawner", &conq_debug_log_vehiclespawner, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log", &conq_debug_log, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_commander", &conq_debug_log_commander, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_requests", &conq_debug_log_requests, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_strategies", &conq_debug_log_strategies, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_classes", &conq_debug_log_classes, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_aichannel", &conq_debug_log_aichannel, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_ometer", &conq_debug_log_ometer, 0, VF_CHEAT, "");
	pConsole->Register("conq_debug_log_area", &conq_debug_log_area, 0, VF_CHEAT, "");
	pConsole->Register("conq_botsJoinBeforePlayer", &conq_botsJoinBeforePlayer, 0, VF_RESTRICTEDMODE, "");
	pConsole->Register("conq_squads_update_delay", &conq_squads_update_delay, 1.0f, VF_CHEAT, "");
	pConsole->Register("conq_area_update_delay", &conq_area_update_delay, 0.15f, VF_CHEAT, "");
	pConsole->Register("conq_respawnTime", &conq_respawnTime, 15, VF_RESTRICTEDMODE || VF_REQUIRE_LEVEL_RELOAD, "");
	pConsole->Register("conq_teamChangeLimit", &conq_teamChangeLimit, 1, VF_RESTRICTEDMODE, "");
	//pConsole->Register("conq_limitTime", &conq_limitTime, 25.0f, VF_RESTRICTEDMODE || VF_REQUIRE_LEVEL_RELOAD, "");
	pConsole->Register("conq_enableHumanHealthRegen", &conq_enableHumanHealthRegen, 1, VF_RESTRICTEDMODE, "");

	pConsole->Register("ctrl_debug_draw", &ctrl_debug_draw, 0, VF_CHEAT, "1 - The Control System debug info");
	pConsole->Register("ctrl_shootRange", &ctrl_shootRange, 1000.0f, VF_CHEAT || VF_READONLY, "");
	pConsole->Register("ctrl_alienEnergyRechargeDelay", &ctrl_alienEnergyRechargeDelay, 1.0f, VF_CHEAT, "");

	pConsole->Register("ctrl_alTargetx", &ctrl_alTargetx, 0.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_alTargety", &ctrl_alTargety, -2.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_alTargetz", &ctrl_alTargetz, 1.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_alFov", &ctrl_alFov, 90.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");

	pConsole->Register("ctrl_pgTargetx", &ctrl_pgTargetx, 0.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Pinger control camera x coordinate");
	pConsole->Register("ctrl_pgTargety", &ctrl_pgTargety, -7.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Pinger control camera y coordinate");
	pConsole->Register("ctrl_pgTargetz", &ctrl_pgTargetz, 9.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Pinger control camera z coordinate");
	pConsole->Register("ctrl_pgFov", &ctrl_pgFov, 80.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Pinger control camera FOV");

	pConsole->Register("ctrl_scTargetx", &ctrl_scTargetx, 1.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera x coordinate");
	pConsole->Register("ctrl_scTargety", &ctrl_scTargety, -13.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera y coordinate");
	pConsole->Register("ctrl_scTargetz", &ctrl_scTargetz, 4.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera z coordinate");
	pConsole->Register("ctrl_scFov", &ctrl_scFov, 80.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera FOV");
	pConsole->Register("ctrl_scAimSupport", &ctrl_scAimSupport, 1, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout enable/disable auto aim support");

	pConsole->Register("ctrl_trWalls", &ctrl_trWalls, 0, VF_CHEAT || VF_SAVEGAME, "Alien Trooper can be attached to walls? (0,1)");
	pConsole->Register("ctrl_trTargetx", &ctrl_trTargetx, 0.7f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera x coordinate");
	pConsole->Register("ctrl_trTargety", &ctrl_trTargety, -2.8f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera y coordinate");
	pConsole->Register("ctrl_trTargetz", &ctrl_trTargetz, 1.75f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera z coordinate");
	pConsole->Register("ctrl_trFov", &ctrl_trFov, 75.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera FOV");

	pConsole->Register("ctrl_hrTargetx", &ctrl_hrTargetx, 0.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera x coordinate");
	pConsole->Register("ctrl_hrTargety", &ctrl_hrTargety, -12.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera y coordinate");
	pConsole->Register("ctrl_hrTargetz", &ctrl_hrTargetz, 22.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera z coordinate");
	pConsole->Register("ctrl_hrFov", &ctrl_hrFov, 70.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera FOV.");
	pConsole->Register("ctrl_hrForwardOffset", &ctrl_hrForwardOffset, 4.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");

	pConsole->Register("ctrl_grDistance", &ctrl_grDistance, 2.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Grunt control camera distance.");
	pConsole->Register("ctrl_grHeight", &ctrl_grHeight, 2.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Grunt control camera height.");
	pConsole->Register("ctrl_grFov", &ctrl_grFov, 60.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Grunt control camera fov.");
	//~TheOtherSide
	...
	pConsole->Register("h_useLookId", &h_useLookId, 1, 0, "");
...
void SCVars::ReleaseCVars()
{
	...
	//TheOtherSide
	pConsole->UnregisterVariable("g_singleplayer_start_map", true);

	pConsole->UnregisterVariable("g_trooperMeleeDamage", true);
	pConsole->UnregisterVariable("g_trooperMeleeDamageMultiplier", true);
	pConsole->UnregisterVariable("g_trooperVehicleDamageMultiplier", true);

	pConsole->UnregisterVariable("sqd_ScoutCanSearch", true);
	pConsole->UnregisterVariable("sqd_HideControls", true);
	pConsole->UnregisterVariable("sqd_TrooperCanSay", true);
	pConsole->UnregisterVariable("sqd_vehicle_follow_method", true);
	pConsole->UnregisterVariable("sqd_debug_draw_Info", true);
	pConsole->UnregisterVariable("sqd_debug_log_creating", true);
	pConsole->UnregisterVariable("sqd_debug_draw_client_squad", true);
	pConsole->UnregisterVariable("sqd_membersUpdateDelay", true);
	pConsole->UnregisterVariable("sqd_detachedUpdateDelay", true);
	//pConsole->UnregisterVariable("sqd_debug_log", true);

	//ability
	pConsole->UnregisterVariable("abil_debug_draw_info", true);
	pConsole->UnregisterVariable("abil_debug_log", true);

	//conqueror
	pConsole->UnregisterVariable("conq_debug_log_area", true);
	pConsole->UnregisterVariable("conq_debug_log_aichannel", true);
	pConsole->UnregisterVariable("conq_debug_log_commander", true);
	pConsole->UnregisterVariable("conq_debug_log_requests", true);
	pConsole->UnregisterVariable("conq_debug_log_vehiclespawner", true);
	pConsole->UnregisterVariable("conq_debug_log_strategies", true);
	pConsole->UnregisterVariable("conq_debug_log_classes", true);
	pConsole->UnregisterVariable("conq_debug_log_ometer", true);
	pConsole->UnregisterVariable("conq_debug_log", true);
	pConsole->UnregisterVariable("conq_debug_draw_commander", true);
	pConsole->UnregisterVariable("conq_debug_draw_commander_squads", true);
	pConsole->UnregisterVariable("conq_debug_draw_aichannel", true);
	pConsole->UnregisterVariable("conq_botsJoinBeforePlayer", true);
	pConsole->UnregisterVariable("conq_botsPerSpeciesCount", true);
	pConsole->UnregisterVariable("conq_botsPerSquadCount", true);
	pConsole->UnregisterVariable("conq_respawnTime", true);
	pConsole->UnregisterVariable("conq_squads_update_delay", true);
	pConsole->UnregisterVariable("conq_teamChangeLimit", true);
	//pConsole->UnregisterVariable("conq_limitTime", true);
	pConsole->UnregisterVariable("conq_enableHumanHealthRegen", true);
	...
	pConsole->UnregisterVariable("ctrl_debug_draw", true);

	//common
	pConsole->UnregisterVariable("ctrl_shootRange", true);
	pConsole->UnregisterVariable("ctrl_alienEnergyRechargeDelay", true);
	//alien
	pConsole->UnregisterVariable("ctrl_alTargetx", true);
	pConsole->UnregisterVariable("ctrl_alTargety", true);
	pConsole->UnregisterVariable("ctrl_alTargetz", true);
	pConsole->UnregisterVariable("ctrl_alFov", true);
	//scout
	pConsole->UnregisterVariable("ctrl_scTargetx", true);
	pConsole->UnregisterVariable("ctrl_scTargety", true);
	pConsole->UnregisterVariable("ctrl_scTargetz", true);
	pConsole->UnregisterVariable("ctrl_scFov", true);
	//hunter
	pConsole->UnregisterVariable("ctrl_hrTargetx", true);
	pConsole->UnregisterVariable("ctrl_hrTargety", true);
	pConsole->UnregisterVariable("ctrl_hrTargetz", true);
	pConsole->UnregisterVariable("ctrl_hrFov", true);
	pConsole->UnregisterVariable("ctrl_hrForwardOffset", true);
	//trooper
	pConsole->UnregisterVariable("ctrl_trWalls", true);
	pConsole->UnregisterVariable("ctrl_trTargetx", true);//
	pConsole->UnregisterVariable("ctrl_trTargety", true);
	pConsole->UnregisterVariable("ctrl_trTargetz", true);
	pConsole->UnregisterVariable("ctrl_trFov", true);
	//grunt
	pConsole->UnregisterVariable("ctrl_grDistance", true);
	pConsole->UnregisterVariable("ctrl_grHeight", true);
	pConsole->UnregisterVariable("ctrl_grFov", true);
	//~TheOtherSide
...
void CGame::RegisterConsoleCommands()
{
	...
	//TheOtherSide commands
	m_pConsole->AddCommand("killSpecies", CmdKillSpecies, VF_CHEAT, "Kill the all members of entered species name and zeroing reinforcements points");
	//~TheOtherSide
}
...
void CGame::UnregisterConsoleCommands()
{
	...
	m_pConsole->RemoveCommand("killSpecies");
}
...
{
	if (!gEnv->bClient || gEnv->bMultiplayer || gEnv->bEditor)
		return;
...
//TheOtherSide
void CGame::CmdKillSpecies(IConsoleCmdArgs* pArgs)
{
	...
	const char* args1 = pArgs->GetArg(1);
	if (args1 == NULL)
	{
		CryLogAlways("Use: killSpecies species_index");
		return;
	}
	...
	const auto speciesType = ESpeciesType(species);
	pConqueror->ForceKillSpecies(speciesType);
}
//~TheOtherSide
...
void CGame::CmdSpectator(IConsoleCmdArgs* pArgs)
{
	...
	{
		g_pControlSystem->GetConquerorSystem()->OnCmdSpectator(pClientActor);
	}
	else
	{
		CGameRules* pGameRules = g_pGame->GetGameRules();
...
void CGame::CmdJoinGame(IConsoleCmdArgs* pArgs)
{
	...
	//TheOtherSide
	if (g_pControlSystem->GetConquerorSystem()->IsGamemode())
		g_pControlSystem->GetConquerorSystem()->OnCmdJoinGame(pClientActor);
	else
	{
...
void CGame::CmdKill(IConsoleCmdArgs* pArgs)
{
	...
	CActor* pClientActor = g_pControlSystem->GetClientActor();
	if (!pClientActor)
		return;

	IPhysicalEntity* pSkipEntities[10]; 
	int nSkip = 0;
	auto pItem = pClientActor->GetCurrentItem();
	if (pItem)
	{
	...
	const auto dir = cam.GetViewdir() * 5000.0f;

	int objtypes = ent_all;
	uint flags = rwi_ignore_noncolliding | rwi_stop_at_pierceable;
	ray_hit rayHit;

	const auto hits = gEnv->pPhysicalWorld->RayWorldIntersection(pos, dir, objtypes, flags, &rayHit, 1, pSkipEntities, nSkip);
	if (hits)
	{
		auto pEntity = gEnv->pEntitySystem->GetEntityFromPhysics(rayHit.pCollider);
		if (pEntity)
		{
			auto pTargetActor = static_cast<CActor*>(g_pGame->GetIGameFramework()->GetIActorSystem()->GetActor(pEntity->GetId()));
			auto pTargetVeh = g_pGame->GetIGameFramework()->GetIVehicleSystem()->GetVehicle(pEntity->GetId());
			
			if (pTargetActor)
			{
				IScriptTable* pTable = pTargetActor->GetEntity()->GetScriptTable();
				if (pTable)
					Script::CallMethod(pTable, "Event_Kill");

				//pTargetActor->Suicide(0.1f);
				return;
			}
			
			if (pTargetVeh)
			{
				const auto& pos = pTargetVeh->GetEntity()->GetWorldPos();
				pTargetVeh->OnHit(pTargetVeh->GetEntityId(), pTargetVeh->GetEntityId(), 18000, pos, 1, "normal", false);
				return;
			}
		}
	}

	if (pClientActor->IsHaveOwner())
	{
		IScriptTable* pTable = pClientActor->GetEntity()->GetScriptTable();
		if (pTable)
			Script::CallMethod(pTable, "Event_Kill");
	}
	else if (pClientActor->IsPlayer())
