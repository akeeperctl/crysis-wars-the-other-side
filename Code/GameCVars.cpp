...
void SCVars::InitCVars(IConsole* pConsole)
{
	...
	//TheOtherSide
	pConsole->Register("ctrl_debug_draw", &ctrl_debug_draw, 0, VF_CHEAT, "1 - The Control System debug info, 2 - The Abilities System debug info");
	...
	pConsole->Register("ctrl_AlienTargetx", &ctrl_AlienTargetx, 0.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_AlienTargety", &ctrl_AlienTargety, -2.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_AlienTargetz", &ctrl_AlienTargetz, 1.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
	pConsole->Register("ctrl_alFov", &ctrl_alFov, 90.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");

	pConsole->Register("ctrl_ScoutTargetx", &ctrl_ScoutTargetx, 1.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera x coordinate");
	pConsole->Register("ctrl_ScoutTargety", &ctrl_ScoutTargety, -13.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera y coordinate");
	pConsole->Register("ctrl_ScoutTargetz", &ctrl_ScoutTargetz, 4.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera z coordinate");
	pConsole->Register("ctrl_scFov", &ctrl_scFov, 80.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout control camera FOV");
	pConsole->Register("ctrl_ScoutAimSupport", &ctrl_ScoutAimSupport, 1, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Scout enable/disable auto aim support");

	pConsole->Register("ctrl_trWalls", &ctrl_trWalls, 0, VF_CHEAT || VF_SAVEGAME, "Alien Trooper can be attached to walls? (0,1)");
	pConsole->Register("ctrl_TrooperTargetx", &ctrl_TrooperTargetx, 0.5f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera x coordinate");
	pConsole->Register("ctrl_TrooperTargety", &ctrl_TrooperTargety, -2.8f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera y coordinate");
	pConsole->Register("ctrl_TrooperTargetz", &ctrl_TrooperTargetz, 1.75f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera z coordinate");
	pConsole->Register("ctrl_trFov", &ctrl_trFov, 60.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Trooper control camera FOV");

	pConsole->Register("ctrl_HunterTargetx", &ctrl_HunterTargetx, 0.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera x coordinate");
	pConsole->Register("ctrl_HunterTargety", &ctrl_HunterTargety, -12.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera y coordinate");
	pConsole->Register("ctrl_HunterTargetz", &ctrl_HunterTargetz, 22.f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera z coordinate");
	pConsole->Register("ctrl_htFov", &ctrl_htFov, 70.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "Alien Hunter control camera FOV.");
	pConsole->Register("ctrl_htForwardOffset", &ctrl_htForwardOffset, 4.0f, VF_SAVEGAME || VF_RESTRICTEDMODE, "");
...
void SCVars::ReleaseCVars()
{
	...
	//alien
	pConsole->UnregisterVariable("ctrl_AlienTargetx", true);
	pConsole->UnregisterVariable("ctrl_AlienTargety", true);
	pConsole->UnregisterVariable("ctrl_AlienTargetz", true);
	pConsole->UnregisterVariable("ctrl_alFov", true);
	//scout
	pConsole->UnregisterVariable("ctrl_ScoutTargetx", true);
	pConsole->UnregisterVariable("ctrl_ScoutTargety", true);
	pConsole->UnregisterVariable("ctrl_ScoutTargetz", true);
	pConsole->UnregisterVariable("ctrl_scFov", true);
	//hunter
	pConsole->UnregisterVariable("ctrl_HunterTargetx", true);
	pConsole->UnregisterVariable("ctrl_HunterTargety", true);
	pConsole->UnregisterVariable("ctrl_HunterTargetz", true);
	pConsole->UnregisterVariable("ctrl_htFov", true);
	pConsole->UnregisterVariable("ctrl_htForwardOffset", true);
	//trooper
	pConsole->UnregisterVariable("ctrl_trWalls", true);
	pConsole->UnregisterVariable("ctrl_TrooperTargetx", true);//
	pConsole->UnregisterVariable("ctrl_TrooperTargety", true);
	pConsole->UnregisterVariable("ctrl_TrooperTargetz", true);
