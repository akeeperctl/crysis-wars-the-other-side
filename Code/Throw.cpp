...
void CThrow::Update(float frameTime, uint frameId)
{
	...
	//if (auto* pOwner = m_pWeapon->GetOwnerActor())
	//{
	//	if (pOwner->IsClient())
	//	{
	//		float color[] = { 1,1,1,1 };
	//		gEnv->pRenderer->Draw2dLabel(20, 40, 1.2, color, false, "m_firing %i", m_firing);
	//		gEnv->pRenderer->Draw2dLabel(20, 60, 1.2, color, false, "m_pulling %i", m_pulling);
	//		gEnv->pRenderer->Draw2dLabel(20, 80, 1.2, color, false, "m_throwing %i", m_throwing);
	//		gEnv->pRenderer->Draw2dLabel(20, 100, 1.2, color, false, "m_thrown %i", m_thrown);
	//		gEnv->pRenderer->Draw2dLabel(20, 120, 1.2, color, false, "m_throwableId %i", m_throwableId);
	//		gEnv->pRenderer->Draw2dLabel(20, 140, 1.2, color, false, "m_hold_timer %1.f", m_hold_timer);
	//		gEnv->pRenderer->Draw2dLabel(20, 160, 1.2, color, false, "m_throw_time %1.f", m_throw_time);
	//	}
	//}
...
void CThrow::StartFire()
{
	...
	{
		m_firing = true; //this spawn grenade and throwing
		m_pulling = true;
		m_throwing = false;
		m_thrown = false;
...
void CThrow::DoThrow()
{
	...
	m_throwing = true;// this true throw
	m_thrown = false;
	...
	//After throwing grenade play the idle animation
