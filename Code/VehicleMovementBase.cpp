...
{
	//TheOtherSide
	g_pControlSystem->AddVehicleMovementInfo(pVehicle->GetEntityId(), this);
	//~TheOtherSide
...
void CVehicleMovementBase::InitSoundNames(const char* eventGroupName)
{
	if (eventGroupName[0])
	{
		string prefix("sounds/vehicles:");
