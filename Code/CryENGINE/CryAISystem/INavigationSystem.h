...
struct INavigationSystem
{
	...
	virtual void RegisterListener(INavigationSystemListener* pListener, const char* name = nullptr) = 0;
	virtual void UnRegisterListener(INavigationSystemListener* pListener) = 0;

	virtual void RegisterUser(INavigationSystemUser* pExtension, const char* name = nullptr) = 0;
