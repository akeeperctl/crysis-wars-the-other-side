...
public:
	...
	public:
		...
		CRadialIterator(const Vec3& pos, float radius, const CHashSpace<T, TraitsT>& hashSpace) : m_curIndex(0), m_radiusSQ(square(radius)), m_Pos(pos), m_object(nullptr), m_hashSpace(hashSpace)
		{
			int32 starti;
