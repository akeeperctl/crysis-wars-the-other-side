...
public:
	...
	//TheOtherSide
	void ToggleHeating(const bool toggle);
	void PerformOverheating();

	// onReason 0 - hide one attachment
	// onReason 1 - show all attachments
	// onReason != 1 - hide all attachments
	void UpdateMachineGunBullets(int ammoCount, int onReason) noexcept; 						


	bool m_IsAllowHeating;
	bool m_IsMachineGun;
	//~TheOtherSide
