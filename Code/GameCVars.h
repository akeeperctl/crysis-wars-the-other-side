...
struct SCVars
{
	...
	//SquadSystem
	float sqd_ScoutCanSearch;
	float sqd_HideControls;
	float sqd_TrooperCanSay;
	//~SquadSystem

	//TheOtherSide

	//debug
	float ctrl_debug_draw;

	//common
	float ctrl_shootRange;
	float ctrl_AlienEnergyRechargeDelay;
	//alien
	float ctrl_AlienTargetx;
	float ctrl_AlienTargety;
	float ctrl_AlienTargetz;
	float ctrl_alFov;

	//scout
	float ctrl_ScoutTargetx;
	float ctrl_ScoutTargety;
	float ctrl_ScoutTargetz;
	float ctrl_scFov;
	float ctrl_ScoutAimSupport;

	//trooper
	float ctrl_trWalls;
	float ctrl_TrooperTargetx;
	float ctrl_TrooperTargety;
	float ctrl_TrooperTargetz;
	float ctrl_trFov;

	//hunter
	float ctrl_HunterTargetx;
	float ctrl_HunterTargety;
	float ctrl_HunterTargetz;
	float ctrl_htFov;
	float ctrl_htForwardOffset;
