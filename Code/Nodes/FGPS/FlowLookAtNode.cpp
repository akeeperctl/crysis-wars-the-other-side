...
// FlowLookAtNode.cpp
//
// Purpose: Flowgraph node to orient an entity to look at another
//
// History:
...
////////////////////////////////////////////////////
class CFlowNode_LookAtEntity : public CFlowBaseNode
{
	enum EInputPorts
	{
		EIP_Look,
...
REGISTER_FLOW_NODE("Entity:LookAtEntity", CFlowNode_LookAtEntity);