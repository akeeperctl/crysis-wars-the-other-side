...
void CPlayerMovement::ProcessFlyMode()
{
	...
	/*if (m_player.GetControlClient())
	{
		CActor*pActor = m_player.GetControlClient()->GetControlledActor();
		if (pActor)
		{
			pActor->GetAnimatedCharacter()->AddMovement(m_request);
		}
	}*/
}
...
void CPlayerMovement::ProcessTurning()
{
	...
	{
		//TheOtherSide
		if (m_player.m_pControlClient && m_player.m_pControlClient->GetControlledActor())
			return;
		//~TheOtherSide
