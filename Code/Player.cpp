...
CPlayer::~CPlayer()
{
	...
	if (m_pControlClient)
	{
		g_pControlSystem->RegisterControlClient(0);
...
void CPlayer::InitLocalPlayer()
{
	...
	m_pControlClient = new SControlClient;
	//m_pControlClient->SetClientId(this->GetEntityId());
	g_pControlSystem->RegisterControlClient(m_pControlClient);
